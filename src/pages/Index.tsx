...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      {/* Premium Header */}
      <header className="bg-white/95 backdrop-blur-lg shadow-sm border-b border-indigo-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                <div className="relative">
                  ...
                  <Sparkles className="h-4 w-4 text-rose-500 absolute -top-1 -right-1" />
                </div>
                <div>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-3">
                <Badge className={`${roleColors[activeRole]} text-white px-4 py-2 font-medium shadow-md`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <Tabs value={activeModule} onValueChange={setActiveModule} className="space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-1 shadow-lg border border-white/40">
            <TabsList className="grid w-full bg-transparent p-0 h-auto" style={{ gridTemplateColumns: `repeat(${getAvailableTabs().length}, 1fr)` }}>
              {getAvailableTabs().map((tab) => (
                <TabsTrigger 
                  key={tab.value} 
                  value={tab.value} 
                  className="flex items-center space-x-2 px-4 py-3 rounded-lg data-[state=active]:bg-gradient-to-r data-[state=active]:from-indigo-500 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg transition-all duration-300 hover:bg-indigo-50"
                >
            ...
            {activeRole === 'superadmin' ? (
              ...
              <>
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-600">Monitor and manage your healthcare network</p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <Card className="hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-violet-50 to-purple-100 hover:scale-105">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-violet-600 mt-1">Active branches</p>
                    </CardContent>
                  </Card>

                  <Card className="hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-blue-50 to-indigo-100 hover:scale-105">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <Card className="hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-emerald-50 to-teal-100 hover:scale-105">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <Card className="hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-rose-50 to-pink-100 hover:scale-105">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-rose-600 mt-1">Active staff members</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6 space-y-4">
                    {branchOverview.map((branch, index) => (
                      <Card key={index} className="border-l-4 border-l-indigo-400 hover:shadow-md transition-all duration-300 bg-gradient-to-r from-white to-indigo-50/50">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                ...
                                <div className="bg-rose-50 p-3 rounded-lg">
                                  <span className="text-rose-600 font-medium">Today's Apps</span>
              ...
              <>
                <div className="flex justify-between items-center">
                  ...
                  <Badge className={`${roleColors[activeRole]} text-white px-4 py-2 shadow-md`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  {activeRole !== 'doctor' && (
                    <Card className="hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-purple-50 to-violet-100 hover:scale-105">
                      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <Button 
                        className="h-20 flex flex-col space-y-2 bg-gradient-to-br from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white shadow-md" 
                      ...
                      <Button 
                        className="h-20 flex flex-col space-y-2 bg-gradient-to-br from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-md" 
                      ...
                      {activeRole === 'doctor' && (
                        <Button 
                          className="h-20 flex flex-col space-y-2 bg-gradient-to-br from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white shadow-md" 
                      ...
                      {activeRole !== 'doctor' && (
                        <Button 
                          className="h-20 flex flex-col space-y-2 bg-gradient-to-br from-rose-500 to-pink-600 hover:from-rose-600 hover:to-pink-700 text-white shadow-md" 
